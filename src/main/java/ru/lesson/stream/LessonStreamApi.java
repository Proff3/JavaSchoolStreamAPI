...
public class LessonStreamApi {
    ...
    public Map<PositionType, Double> task8(List<Employee> employees) {
        return employees
                .stream()
                .collect(Collectors.groupingBy(Employee::getPositionType, Collectors.averagingDouble(Employee::getRating)));
    }
    ...
    public Map<Boolean, Long> task9(List<Employee> employees) {
        return employees
                .stream()
                .collect(Collectors
                        .partitioningBy(employee -> employee.getRating() > 50, Collectors.counting()));
    }
    ...
    public Map<Boolean, String> task10(List<Employee> employees) {
        return employees
                .stream()
                .collect(Collectors
                        .partitioningBy(employee -> employee.getRating() > 50,
                                Collectors
                                        .mapping(Employee::getName, Collectors.joining(", "))));
    }
